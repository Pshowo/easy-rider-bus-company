...
class Test_main(unittest.TestCase):
    ...
    def test_check(self):
        self.assertEqual(check(t1), {"errors": 8, "bus_id": 2, "stop_id": 1, "stop_name": 1, "next_stop": 1, "stop_type": 1, "a_time": 2})
        self.assertEqual(check(t2), {"errors": 0, "bus_id": 0, "stop_id": 0, "stop_name": 0, "next_stop": 0, "stop_type": 0, "a_time": 0})
        self.assertEqual(check(t3), {"errors": 18, "bus_id": 3, "stop_id": 3, "stop_name": 8, "next_stop": 3, "stop_type": 4, "a_time": 7})
        self.assertEqual(check(t4), {"errors": 9, "bus_id": 0, "stop_id": 0, "stop_name": 3, "next_stop": 0, "stop_type": 2, "a_time": 4})
